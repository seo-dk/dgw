...
def Set_Info(**context):
    ...
    logging.info(f'interface: [{interface}], files [{files}]')
...
def re_Run(**context):
    ...
    interface = context['dag_run'].conf.get('interface')
    files = context['dag_run'].conf.get('files')
    dag_run_id = context['dag_run'].run_id
    
    logging.info(f'interface: [{interface}], dag_run_id: [{dag_run_id}] files [{files}]')
