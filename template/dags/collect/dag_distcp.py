...
from commons.DistcpBatchManager import DistcpBatchManager
from datetime import datetime, timedelta
import pendulum
from commons.SmsSender import send_sms_alert

def execute_task(**context):
    DistcpBatchManager(context).execute()
...
with DAG(
    ...
    start_date=datetime(2024, 10, 15, tzinfo = pendulum.timezone('Asia/Seoul')),
    catchup=False,
