...
from commons.KafkaCollectManager import KafkaCollectManager
from datetime import datetime, timedelta
import pendulum
from commons.SmsSender import send_sms_alert

def execute_task(**context):
    KafkaCollectManager(context).start()
...
with DAG(
    ...
    start_date=datetime(2024, 10, 29, tzinfo = pendulum.timezone('Asia/Seoul')),
    catchup=False,
