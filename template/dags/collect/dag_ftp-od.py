...
def execute_task(**context):
    ...
    OdCollectManager().execute(context, dag_id, task_id)
...
with DAG(
    ...
    execute_task_operator = PythonOperator(task_id = 'ExcuteTask', provide_context = True, python_callable = execute_task, on_failure_callback=(None if $IGNORE_SMS_ALERT else send_sms_alert))
