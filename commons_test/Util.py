...
class Util:
    ...
    def get_target_time(cls, time_patterns, file_nm, start_time, target_time=None):
        ...
        # test log
        logger.info("time_pattern arr : %s", time_patterns)
        logger.info("file_info : %s", file_nm)
    ...
    def _extract_calculation_from_pattern(cls, pattern):
        ...
        logger.info("calculation : %s, base_pattern : %s ", calculation, base_pattern)
    ...
    def replace_time_pattern(cls, source_infos, interface_info, target_time=None):
        ...
        for source_info in source_infos:
            ...
            # test log
            logger.info("file_source_pattern : %s", file_source_pattern)
            logger.info("file_nm_pattern : %s", file_nm_pattern)
        ...
        logger.info(f"interface_file_nm_pattern : {interface_filenm_pattern}")
        logger.info(f"source_dir_timepattern : {source_dir_timepattern}")
