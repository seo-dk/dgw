...
if __name__ == "__main__":
    checkParquetExecutor = CheckParquetExecutor()
    checkParquetExecutor.check_if_parquet("hdfs://dataGWCluster/idcube_out/db=o_common_raw/tb=bin_10by10_daily/dt=20240507")