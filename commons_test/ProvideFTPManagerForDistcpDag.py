...
class ProvideFTPManagerForDistcpDag:
    ...
    def _prepare_dest_paths(self):
        ...
        # test
        self.formatted_target_dir = self._get_formatted_target_dir(self.partitions_dict, target_dir) + "/test"
        ...
        if self.version == "2" or self.version == "3":
            if not self.provide_interface.proto_info_json.use_origin_path:
                ...
                logger.info("for version %s, formatted_target_dir: %s", self.version, self.formatted_target_dir)
