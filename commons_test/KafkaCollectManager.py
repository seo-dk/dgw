...
from commons_test.KafkaMessageHandler import KafkaMessageHandler
from commons_test.HdfsFileUploader import HdfsFileUploader
from commons_test.KafkaSend import KafkaSend
from commons_test.MetaInfoHook import MetaInfoHook, InterfaceInfo
...
class KafkaCollectManager:
    ...
    def start(self):
        ...
        try:
            ...
            manager = KafkaMessageHandler(interface_info, source_infos, kafka_send, collect_history)
            manager.start()
