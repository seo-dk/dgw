...
from commons_test.MetaInfoHook import CryptoRules, ColumnCryptoInfo
from commons_test.HdfsUtil import make_directory, put_files
...
class CryptoExecutor:
    ...
    def _upload_raw_data_to_hadoop(self, result_file_full_path):
        ...
        staging_hdfs_path = result_file_dir.replace("/data/test/idcube_out", "/test/staging/raw/idcube_out")
        staging_local_path = str(result_file_full_path).strip().replace("/data/test/idcube_out", "/data/test/staging/raw/idcube_out")
...
## what can I test in here
## self.crypto_rules.store_raw_and_crypto and just encrypt