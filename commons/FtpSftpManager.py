...
from commons.PcellJarExecutor import PcellJarExecutor
from commons.MergeToParquet import MergeToParquet
from commons.CollectHistory import CollectHistory
from commons.KafkaSend import KafkaSend
from commons.FtpSftpFileHandler import FtpSftpFileHandler
from commons.FtpSftpDownloader import FtpSftpDownloader
from commons.PathUtil import LocalPathInfos, PartitionInfos
...
class FtpSftpManager:
    ...
    def _get_filelist_from_server(self, connection, source_info: SourceInfo):
        ...
        logger.info("file count in ftp server: %s", len(server_files))
        return server_files
    ...
    def check_tar_gz(self, connection, collect_history: CollectHistory, source_infos):
        ...
        for noti_file in match_noti_files:
            ...
            gz_path = Path("/idcube_out", self.interface_info.interface_id, self.interface_info.target_time[:8])
