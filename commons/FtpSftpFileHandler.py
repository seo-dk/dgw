...
from commons.DelimiterChanger import DelimiterChanger
from commons.ExcelToCsv import ExcelToCsv
...
from commons.CryptoExecutor import CryptoExecutor
...
class FtpSftpFileHandler:
            ...
            if source_info.file_proto_info.convert_to == "parquet" and not source_info.file_proto_info.merge:
                ...
                if not source_info.file_proto_info.merge:
                    ...
                    for parquet_file in parquet_files:
                        logger.debug("parquet_files: %s", parquet_file)
    ...
    def _delete_columns(self, source_info: SourceInfo, local_path_infos: LocalPathInfos, interface_info: InterfaceInfo):
        ...
        def _delete(file_lines, write_file, _source_info: SourceInfo, file_delimiter):
            delete_columns = _source_info.file_proto_info.delete_columns
        ...
        if source_info and source_info.file_proto_info.delete_columns:
            ...
            _delete(lines, tmp_file_path, source_info, delimiter)
