...
from commons.DistcpBatchHandler import DistcpBatchHandler
...
class DistcpBatchManager:
    ...
    def _get_hdfs_dest_path(self, hdfs_src_path, hdfs_dest_dir, source_info: SourceInfo, interface_info: InterfaceInfo):
        ...
        if proto_partitions:
            proto_segments = PathUtil.get_distcp_batch_partition_segments(
                source_info, interface_info, interface_info.start_time
            )
            if proto_segments:
