...
class FtpHandler:
    ...
    def _check_zip_file(self, interface_info: InterfaceInfo, source_info: SourceInfo, local_tmp_full_path, partitions, local_path_infos: LocalPathInfos, collect_history: CollectHistory, ulid):
